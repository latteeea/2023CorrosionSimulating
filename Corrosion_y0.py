...
def comb(a, b, x0, y0, m, r1, r2, x1, x2, y1, y2, times):
        ...
        if (t == 0):
            ...
            if (len(error) > 0):    #결합
                for i in range(len(error)):
                    a = error[i][0]
                    b = error[i][1]
                    circle[a] = comb(a, b, x0, y0, m, circle[a][2], circle[b][2], circle[a][0], circle[b][0], circle[a][1], circle[b][2], t)
            ...
            if (len(error) >= 1):
                ...
                try: 
                    circle[aa] = comb(a, b, x0, y0, m, circle[aa][2], circle[bb][2], circle[aa][0], circle[bb][0], circle[aa][1], circle[bb][1], t)
